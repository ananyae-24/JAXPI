...
def get_dataset(T=2.0, L=1, c=2, n_t=200, n_x=128):
    grid,val1=process_file("./data/Phi_w_.5_lognorm_.75.txt") 
    grid1,val2=process_file("./data/Phi_d_.5_lognorm_.75.txt")
    grid2,gme=process_file("./data/G_me_.5_lognorm_.75.txt")
